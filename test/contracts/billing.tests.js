...
const SimpleBillingProcessor = artifacts.require('SimpleBillingProcessor');
...
contract('SimpleBillingProcessor', (accounts) => {
    ...
    beforeEach(async function () {
        ...
        this.billing = await SimpleBillingProcessor.new(acc1, this.mint.address);
    });
    ...
    describe('(unit tests)', () => {
        describe('initialized contract', () => {
            it('should return correct getContractVersion()', async function () {
                ...
                assert.equal(version, 'SimpleBillingProcessor');
            });
        ...
        describe('registerEventContract', () => {
            ...
            it('should add new event', async function () {
                ...
                const ret = await this.billing.getEventAtIndex(0).should.be.fulfilled;
        ...
        describe('registerEventContractCustomRules', () => {
            it('should fail if called by non-owner', async function () {
                await this.billing.registerEventContractCustomRules(acc2, 500000, 1000000, { from: acc1 }).should.be.rejectedWith('revert');
            });
            ...
            it('should not add event with bad orgGets', async function () {
                ...
                await this.billing.registerEventContractCustomRules(acc2, totalFee, orgGets, { from: creator }).should.be.rejectedWith('revert');
                const ier = await this.billing.isEventRegistered(acc2);
            ...
            it('should add new event even if totalFee is more than 100%', async function () {
                ...
                await this.billing.registerEventContractCustomRules(acc2, totalFee, orgGets, { from: creator }).should.be.fulfilled;
                const ier = await this.billing.isEventRegistered(acc2);
                assert.equal(ier, true);
        ...
        describe('updateEventContractCustomRules', () => {
            beforeEach(async function () {
                const totalFee = 500000;
                const orgGets = 200000;
                await this.billing.registerEventContractCustomRules(acc2, totalFee, orgGets, { from: creator }).should.be.fulfilled;
            ...
            it('should fail if called by non-owner', async function () {
                await this.billing.updateEventContractCustomRules(acc2, 500000, 1000000, { from: acc1 }).should.be.rejectedWith('revert');
            });

            it('should fail if no such event by non-owner', async function () {
                await this.billing.updateEventContractCustomRules(acc3, 500000, 1000000, { from: creator }).should.be.rejectedWith('revert');
            });

            it('should not update params if orgGets', async function () {
                // add acc2 as an event contract ...
                const totalFee = 1000000;
                const orgGets = 1100000;
                await this.billing.updateEventContractCustomRules(acc2, totalFee, orgGets, { from: creator }).should.be.rejectedWith('revert');
            });
            ...
            it('should update params even if totalFee is more than 100%', async function () {
                ...
                const totalFee = 1100000;
                const orgGets = 200000;
                await this.billing.updateEventContractCustomRules(acc2, totalFee, orgGets, { from: creator }).should.be.fulfilled;
                const ier = await this.billing.isEventRegistered(acc2);
                assert.equal(ier, true);
                ...
                const ret2 = await this.billing.getEventContractRules(acc2).should.be.fulfilled;
        ...
        describe('isEventRegistered', () => {
            ...
            it('should return true if event was added before', async function () {
                ...
                await this.billing.registerEventContractCustomRules(acc2, totalFee, orgGets, { from: creator });
        ...
        describe('getEventsCount', () => {
            ...
            it('should return 2 if two event was added before', async function () {
                ...
                await this.billing.registerEventContractCustomRules(acc3, totalFee2, orgGets2, { from: creator });
        ...
        describe('getEventAtIndex', () => {
            it('should throw if index is bad', async function () {
                await this.billing.getEventAtIndex(0).should.be.rejectedWith('revert');
            });
        ...
        describe('onSell', () => {
            ...
            it('should revert if called not from event', async function () {
                ...
                await this.billing.onSell(ticketUnused, this.st.address, owner, to, org,
            ...
            it('should sell ticket from acc3 to acc1 (first price==last price)', async function () {
                ...
                await this.billing.onSell(ticketUnused, this.st.address, owner, buyer, org,
                    firstPrice, lastPrice, newPrice, false, { from: acc2 }).should.be.fulfilled;

                // org earns 50% of the markup = $10
                const bOrg = await this.st.balanceOf(org);
                assert.equal(bOrg - bOrg1, 1000);
        ...
        describe('getStats', () => {
            ...
            it('should return correct stats after single ticket is sold', async function () {
                ...
                // 5 - sell
                await this.billing.onSell(ticketUnused, this.st.address, buyer, org, org,
                ...
                await this.billing.onSell(ticketUnused, this.st.address, org, buyer, org,
                    firstPrice, lastPrice, newPrice, false, { from: fakeEventContract }).should.be.fulfilled;
        ...
        describe('onRefund', function(){
            ...
            it('should do nothing', async function() {
                ...
                // TODO: wont work without event
                await this.billing.onRefund(ticketUnused, this.st.address, owner, org,
                    {from: acc2}).should.be.fulfilled;
                ...
                assert.equal(s.refunded.toNumber(),2000);
